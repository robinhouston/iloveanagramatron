! function() {
    ...
    provide("util/util", function(t) {
        ...
        using("util/typevalidator", function(e) {
            function i() {
                var t, e, i = document.getElementsByTagName("meta"),
                    n = 0;
        ...
        using("util/util", function(e) {
            ...
            var l = ["con", "sole"].join(""),
                c = {}, d = !! ~location.href.indexOf("tw_debug=true");
            t({
                info: i,
                warn: n,
                error: r,
        ...
        function r(t) {
            var e, n, r, o, s = {};
            if (t)
                for (e = t.split("&"), o = 0; r = e[o]; o++) n = r.split("="), 2 == n.length && (s[i(n[0])] = i(n[1]));
            return s
        }
        ...
        using("util/params", function(e) {
            function i() {
                var t = 36e5,
                    i = e.combined(document.location)._;
        ...
        using("tfw/util/env", "util/env", function(e, i) {
            ...
            function r() {
                var t, i, o, a, u, h, f = {};
                if ("function" === (typeof arguments[0]).toLowerCase() ? f.success = arguments[0] : f = arguments[0], t = f.success || function() {}, i = f.timeout || function() {}, o = f.nohub || function() {}, a = f.complete || function() {}, u = void 0 !== f.attempt ? f.attempt : d, !e.isDynamicWidget() || s) return o(), a(), !1;
                h = n(), u--;
                try {
            ...
            var o, s, a = "twttrHubFrameSecure",
                u = "http:" == document.location.protocol ? "twttrHubFrame" : a,
                l = +new Date,
                c = 100,
                d = 20;
            t({
        ...
        using("util/promise", function(e) {
            ...
            i.prototype.enqueue = function(t, i) {
                ...
                var t, e = r;
                if (e.length)
                    for (r = []; e.length;) t = e.shift(), t && t.action ? t.resolver.fulfill(t.action()) : t.resolver.reject()
            ...
            switch (u && "object" == typeof u && "function" == typeof u.toJSON && (u = u.toJSON(t)), "function" == typeof rep && (u = rep.call(e, t, u)), typeof u) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep)
                        for (o = rep.length, i = 0; o > i; i += 1) n = rep[i], "string" == typeof n && (r = str(n, u), r && s.push(quote(n) + (gap ? ": " : ":") + r));
                    else
                        for (n in u) Object.hasOwnProperty.call(u, n) && (r = str(n, u), r && s.push(quote(n) + (gap ? ": " : ":") + r));
                    return r = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, r
            }
        }
        ...
        "function" != typeof JSON.stringify && (JSON.stringify = function(t, e, i) {
            ...
            else "string" == typeof i && (indent = i); if (rep = e, e && "function" != typeof e && ("object" != typeof e || "number" != typeof e.length)) throw new Error("JSON.stringify");
            return str("", {
                "": t
            })
            ...
            function walk(t, e) {
                ...
                if (r && "object" == typeof r)
                    for (i in r) Object.hasOwnProperty.call(r, i) && (n = walk(r, i), void 0 !== n ? r[i] = n : delete r[i]);
        ...
        using("util/querystring", function(e) {
            ...
            var h = /(?:^|(?:https?\:)?\/\/(?:www\.)?twitter\.com(?:\:\d+)?(?:\/intent\/(?:follow|user)\/?\?screen_name=|(?:\/#!)?\/))@?([\w]+)(?:\?|&|$)/i,
                f = /(?:^|(?:https?\:)?\/\/(?:www\.)?twitter\.com(?:\:\d+)?\/(?:#!\/)?[\w_]+\/status(?:es)?\/)(\d+)/i,
                m = /^http(s?):\/\/(\w+\.)*twitter\.com([\:\/]|$)/i,
        ...
        using("util/querystring", "util/util", "util/twitter", function(e, i, n) {
            ...
            function s() {
                for (var t, e, i, r = document.getElementsByTagName("a"), o = document.getElementsByTagName("link"), s = [r, o], a = 0, u = 0, l = /\bme\b/; t = s[a]; a++)
                    for (u = 0; e = t[u]; u++)
                        if (l.test(e.rel) && (i = n.screenName(e.href))) return i
            }
            t({
                absolutize: r,
                getCanonicalURL: o,
        ...
        using("util/domready", "util/env", "util/iframe", "util/promise", "util/util", function(e, i, n, r, o) {
            ...
            window.twttr = window.twttr || {}, window.twttr.sandbox = window.twttr.sandbox || {}, s.prototype.getCallback = function(t) {
                ...
                var t = n(this.attrs, this.styles),
                    e = this.registerCallback(this.getCallback(this.onLoad));
        ...
        using("dom/cookie", "dom/delegate", "sandbox/minimal", "util/donottrack", "util/promise", "util/querystring", "util/tld", "tfw/util/env", "util/iframe", "util/util", "xd/json2", function(i, n, r, o, s, a, u, l, c, d) {
            function h() {
                return F ? W : (r.createSandbox({
                    id: "rufous-sandbox"
                }, {
                    display: "none"
                }).then(d.bind(function(t) {
            ...
            function g(t, e, i) {
                var n, r;
                i && d.isObject(t) && d.isObject(e) && (n = d.aug({}, e, {
                    event_namespace: t
                }), r = {
                    l: L(n)
                }, n.dnt && (r.dnt = 1), O(a.url(i, r)))
            }

            function v(t, e, i) {
                var n, r, o, s;
                d.isObject(t) && d.isObject(e) && (i ? g(t, e, U) : (o = d.aug({}, e, {
                    event_namespace: t
                }), n = C.firstChild, n.value = +(+n.value || o.dnt || 0), s = L(o), r = R.createElement("input"), r.type = "hidden", r.name = "l", r.value = s, C.appendChild(r)))
            }
            ...
            function T(t, e) {
                u.isHostPageSensitive() || H[t] || (H[t] = !0, g(E({
                    page: t,
                    action: "impression"
                }), N(e), z))
            }
            ...
            var C, P, R, j, M = 0,
                ...
                H = {}, U = "https://syndication.twitter.com/i/jot",
                z = "https://syndication.twitter.com/i/jot/syndication",
                K = "https://platform.twitter.com/jot.html";
        ...
        using("util/util", function(e) {
            ...
            var r = function() {
                ...
                return e.isNative(t) ? function(i, n, r, o) {
                    var s = n ? n.getElementsByClassName(i) : t.call(document, i),
                        a = e.filter(s, function(t) {
        ...
        using("dom/get", "performance/perf-timers", "tfw/util/article", "util/domready", "util/iframe", "util/layout", "util/promise", "util/querystring", "util/typevalidator", "util/util", "tfw/util/globals", "util/logger", function(e, i, n, r, o, s, a, u, l, c, d, h) {
            function f(t) {
                ...
                t && (t.ownerDocument ? (this.srcEl = t, this.classAttr = t.className.split(" ")) : (this.srcOb = t, this.classAttr = []), e = this.params(), this.id = this.generateId(), this.setLanguage(), this.related = e.related || this.dataAttr("related"), this.partner = e.partner || this.dataAttr("partner") || d.val("partner"), this.dnt = e.dnt || this.dataAttr("dnt") || d.dnt() || "", this.styleAttr = [], this.targetEl = t.targetEl, b[this.id] = this, this.completePromise = new a(c.bind(function(t) {
                    ...
                    t && t != document.body && twttr.events.trigger("rendered", {
                        target: t
                    })
                }))
            }
            ...
            c.aug(f.prototype, {
                ...
                i.endAndTrack("render", "widgets-js-load", "page", {
                    widget_origin: n.url()
                }, m(t))
        ...
        function e(t, e) {
            var i = e || Math.floor(100 * Math.random()),
                n = ['<object id="xdflashshim' + i + '" name="xdflashshim' + i + '"', 'type="application/x-shockwave-flash" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"', 'width="1" height="1" style="position:absolute;left:-9999px;top:-9999px;">', '<param name="movie" value="' + t + "&debug=" + window.__XDDEBUG__ + '">', '<param name="wmode" value="window">', '<param name="allowscriptaccess" value="always">', "</object>"].join(" ");
            return n
        }
        t({
            object: e
            ...
            o.prototype = new e.Connection, i.aug(o.prototype, {
                ...
                _createIframe: function() {
                    ...
                    var e, n, r, o, s = this,
                        a = {
                            ...
                            tabIndex: "0",
                            name: this._name()
                        }, u = i.aug(i.aug({}, a), this.options.iframe),
                        c = !1;
                ...
                _createWindow: function() {
                    var t, e = {
                            ...
                            scrollbars: "1",
                            resizable: "1"
                        }, n = i.aug(i.aug({}, e), this.options.window),
                        o = screen.width,
                        s = screen.height,
                        a = this._name();
        ...
        using("xd/parent", "xd/jsonrpc", "tfw/widget/base", "util/widgetrpc", function(e, i, n, r) {
            ...
            function a(t, e) {
                var i = t.assetUrl(e) + "/widgets/hub.1c5a573e465d84666458a45e49b0a735.html",
                    n = s(e);
        ...
        using("dom/delegate", "dom/get", "util/util", "util/env", "util/twitter", function(e, i, n, r, o) {
            ...
            function u(t, e, i) {
                ...
                if (t = window.devicePixelRatio ? t * window.devicePixelRatio : t, o = n.map(e.split(","), function(t) {
                    ...
                    for (u = 0; u < o.length; u++) o[u].url === i && (r = o[u]);
            ...
            function d(t, e, r, o) {
                var a = 0,
                    u = r ? 600 : 375,
                    c = i.one("multi-photo", t, "DIV"),
                    d = c && +c.getAttribute("data-photo-count");
                if (t) return n.forEach(i.all("autosized-media", t), function(t) {
                    ...
                    var i, n, r, c = e - 12,
                        f = t.parentNode,
                        g = t.getAttribute("data-crop-x") || 0,
                        v = t.getAttribute("data-crop-y") || 0,
                        b = s(d, t.getAttribute("data-image-index")),
                        y = Math.floor(c / 2 - m),
                        _ = Math.floor(y / (b ? w : p));
        ...
        using("util/logger", "util/util", "util/querystring", function(e, i, n) {
            ...
            var a = "twttr.tfw.callbacks",
                u = twttr.tfw.callbacks,
                l = "cb",
                c = 0,
                d = !1,
                h = {}, f = {
        ...
        using("util/util", "util/promise", "xd/json2", function(e, i) {
            ...
            n.prototype._invoke = function(t, n) {
                ...
                var s, c = !! t.id;
                return o(t) ? s = "params" in t && !a(t.params) ? i.fulfill(l(t.id, m)) : this.registry[t.method] ? this._invoke(t, {
                    source: e
                }).then(n, r) : i.fulfill(l(t.id, w)) : (c = !0, s = i.fulfill(l(t.id, f))), c ? s : i.fulfill()
        ...
        using("util/util", "dom/get", "tfw/util/tracking", "rpc/jsonrpc_server", "rpc/postmessage", function(e, i, n, r, o) {
            ...
            function u(t, n) {
                var r = i.ancestor(".cards-multimedia", n),
                    o = i.ancestor(".tweet", n),
                    a = e.aug({
                        item_type: c,
                        id: s(o, "tweet-id"),
            ...
            l.prototype.findIframeByWindow = function(t) {
                var e, i = this.global.document.getElementsByTagName("iframe"),
                    n = i.length;
                for (e = 0; n > e; e++)
                    if (i[e].contentWindow == t) return i[e]
        ...
        using("tfw/widget/base", "util/util", "util/querystring", "util/twitter", "util/uri", "util/promise", function(e, i, n, r, o, s) {
            ...
            function l(t) {
                var e = ~location.host.indexOf("poptip.com") ? "https://poptip.com" : location.href,
                    i = "original_referer=" + e;
            ...
            var m, w = /twitter\.com(\:\d{2,4})?\/intent\/(\w+)/,
                p = "scrollbars=yes,resizable=yes,toolbar=no,location=yes",
                g = 550,
                v = 520,
                b = screen.height,
                y = screen.width;
        ...
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "tfw/util/media", "tfw/util/tracking", "amplify/video_scribe_bridge", "dom/classname", "dom/get", "dom/delegate", "dom/size", "sandbox/frame", "util/env", "util/promise", "util/twitter", "util/typevalidator", "util/util", function(e, i, n, r, o, s, a, u, l, c, d, h, f, m, w, p, g) {
            ...
            var _, T, x, A = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:focus", ".customisable:active", ".customisable-highlight:hover", ".customisable-highlight:focus", "a:hover .customisable-highlight", "a:focus .customisable-highlight"],
                E = ["a:hover .ic-mask", "a:focus .ic-mask"],
                I = [".customisable-border"],
            ...
            b.prototype = new e, g.aug(b.prototype, {
                ...
                bindIntentHandlers: function() {
                    function t(t) {
                        var i = l.ancestor(".tweet", this, n),
                            r = g.aug({}, e.baseScribeData(), {
                                item_ids: [],
                ...
                collapseRegions: function() {
                    g.forEach(l.all("collapsible-container", this.element), g.bind(function(t) {
                        var e, i, n = t.children,
                            r = n.length && t.offsetWidth,
                            o = n.length && g.map(n, function(t) {
        ...
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "util/promise", "anim/transition", "performance/perf-timers", "tfw/util/article", "tfw/util/data", "tfw/util/media", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env", "util/throttle", "util/twitter", "util/querystring", "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function(e, i, n, r, o, s, a, u, l, c, d, h, f, m, w, p, g, v, b, y, _) {
            function T(t) {
                if (t) {
                    var e, n, r, o, s, a, u, l;
                    i.apply(this, [t]), e = this.params(), n = (e.chrome || this.dataAttr("chrome") || "").split(" "), this.preview = e.previewParams, this.widgetId = e.widgetId || this.dataAttr("widget-id"), this.instanceId = ++H, this.cursors = {
                        maxPosition: 0,
                        minPosition: 0
                        ...
                        overrideId: s,
                        overrideName: o,
                        withReplies: g.asBoolean(e.showReplies || this.dataAttr("show-replies")) ? "true" : "false"
                        ...
                        overrideType: "custom",
                        overrideId: l
                    } : {}, this.tweetLimit = g.asInt(e.tweetLimit || this.dataAttr("tweet-limit")), this.staticTimeline = this.tweetLimit > 0, n.length && (r = ~v.indexOf(n, "none"), this.chromeless = r || ~v.indexOf(n, "transparent"), this.headerless = r || ~v.indexOf(n, "noheader"), this.footerless = r || ~v.indexOf(n, "nofooter"), this.borderless = r || ~v.indexOf(n, "noborders"), this.noscrollbar = ~v.indexOf(n, "noscrollbar")), this.headingStyle = h.sanitize(e.headingStyle || this.dataAttr("heading-style"), void 0, !0), this.classAttr.push("twitter-timeline-rendered"), this.ariaPolite = e.ariaPolite || this.dataAttr("aria-polite")
                }
            }
            var x = {
                CLIENT_SIDE_USER: 0,
                ...
                C = "expand",
                P = "permalink",
                R = "twitter-follow-button",
                j = "no-more-pane",
                M = "pending-scroll-in",
                F = "pending-new-tweet",
                W = "pending-new-tweet-display",
                H = 0;
            T.prototype = new i, v.aug(T.prototype, {
                ...
                create: function(t) {
                    var i, n, o, s, a = this.sandbox.createElement("div"),
                        u = [];
                    return a.innerHTML = t.body, (i = a.children[0] || !1) ? (this.reconfigure(t.config), this.discardStaticOverflow(i), this.sandbox.setTitle(i.getAttribute("data-iframe-title") || "Timeline"), l.retinize(i), this.constrainMedia(i), this.searchQuery = i.getAttribute("data-search-query"), this.profileId = i.getAttribute("data-profile-id"), this.timelineType = i.getAttribute("data-timeline-type"), s = this.getTweetDetails(_.one(k, a)), v.forIn(s, function(t) {
                        u.push(t)
                    }), o = this.baseScribeData(), o.item_ids = u, o.item_details = s, this.timelineType && c.enqueue({
                        page: this.timelineType + "_timeline",
                        component: "timeline",
                        element: "initial",
                        action: u.length ? "results" : "no_results"
                    }, o, !0, this.dnt), c.enqueue({
                        page: "timeline",
                        component: "timeline",
                        element: "initial",
                        action: u.length ? "results" : "no_results"
                    }, o, !0, this.dnt), c.scribeTimelineAudienceImpression(this.dnt), c.flush(), "assertive" == this.ariaPolite && (n = _.one(E, i, "DIV"), n.setAttribute("aria-polite", "assertive")), i.id = this.id, i.className += " " + this.classAttr.join(" "), i.lang = this.lang, this.augmentWidgets(i), this.ready().then(v.bind(function(t) {
                ...
                getTimeline: function() {
                    c.initPostLogging(), u.timeline(v.aug({
                        id: this.widgetId,
                        ...
                        success: v.bind(function(t) {
                            this.ready().then(v.bind(function() {
                                this.element = this.create(t), this.readTranslations(), this.bindInteractions(), this.updateTimeStamps(), this.updateCursors(t.headers, {
                                    initial: !0
                                }), t.headers.xPolling && /\d/.test(t.headers.xPolling) && (this.pollInterval = 1e3 * t.headers.xPolling), this.staticTimeline || this.schedulePolling(), e.doLayoutAsync()
                            }, this))
                        }, this),
                        error: v.bind(function(t) {
                            return t && t.headers ? void this.completeResolver.reject(t.headers.status) : void this.completeResolver.fulfill(this.srcEl)
                ...
                forceLoad: function() {
                    var t = this,
                        e = !! _.all(k, this.element, "OL").length;
                    ...
                    e && this.cursors.maxPosition ? r.minPosition = this.cursors.maxPosition : !e && this.cursors.minPosition ? r.maxPosition = this.cursors.minPosition : e ? r.sinceId = t : r.maxId = t, r.complete = function() {
                        ...
                        if (n.updateCursors(t.headers, {
                            ...
                            for (o = n.getTweetDetails(a), v.forIn(o, function(t) {
                                u.push(t)
                            }), u.length && (r = n.baseScribeData(), r.item_ids = u, r.item_details = o, r.event_initiator = e ? x.CLIENT_SIDE_APP : x.CLIENT_SIDE_USER, this.timelineType && c.enqueue({
                                page: this.timelineType + "_timeline",
                                component: "timeline",
                                element: "initial",
                                action: u.length ? "results" : "no_results"
                            }, r, !0, this.dnt), c.enqueue({
                                page: "timeline",
                                component: "timeline",
                                element: e ? "newer" : "older",
                                action: "results"
                            }, r, !0, n.dnt), c.flush()), l.retinize(a), n.constrainMedia(a); a.children[0];) s.appendChild(a.children[0]);
                            i(s)
                        }
                ...
                insertNewTweets: function(t) {
                    var e, i = this,
                        n = _.one(S, this.element, "DIV"),
                        r = _.one(k, n, "OL"),
                        s = r.offsetHeight;
                    return r.insertBefore(t, r.firstChild), e = r.offsetHeight - s, twttr.events.trigger("timelineUpdated", {
                        target: this.sandbox.element(),
                        region: "newer"
                    }), n.scrollTop > 40 || this.mouseIsOver() ? (n.scrollTop = n.scrollTop + e, this.updateTimeStamps(), void this.showNewTweetNotifier()) : (y.remove(this.element, M), r.style.cssText = "margin-top: -" + e + "px", window.setTimeout(function() {
                ...
                appendTweets: function(t) {
                    var e = _.one(S, this.element, "DIV"),
                        i = _.one(k, e, "OL");
                ...
                hideStreamScrollBar: function() {
                    var t, e = _.one(S, this.element, "DIV"),
                        i = _.one(k, this.element, "OL");
                ...
                updateTimeStamps: function() {
                    for (var t, e, i, n, r = _.all(P, this.element, "A"), o = 0; t = r[o]; o++) i = t.getAttribute("data-datetime"), n = i && this.datetime.timeAgo(i, this.i18n), e = t.getElementsByTagName("TIME")[0], n && (e && e.innerHTML ? e.innerHTML = n : t.innerHTML = n)
                },
                ...
                showNSFW: function(t) {
                    var e, i, n, r, o, s, a = _.one("nsfw", t, "DIV"),
                        u = 0;
                ...
                toggleExpando: function(t) {
                    var i, n, r = _.one(L, t, "DIV"),
                        o = r && r.children[0],
                        s = o && o.getAttribute("data-expanded-media"),
                        a = 0,
                        u = _.one(C, t, "A"),
                        c = u && u.getElementsByTagName("B")[0],
                        d = c && (c.innerText || c.textContent);
                    if (c) {
                        if (this.layout(function() {
                            c.innerHTML = u.getAttribute("data-toggled-text"), u.setAttribute("data-toggled-text", d)
                        }), y.present(t, O)) return this.layout(function() {
                            y.remove(t, O)
                ...
                recalculateStreamHeight: function(t) {
                    var e = _.one(I, this.element, "DIV"),
                        i = _.one(N, this.element, "DIV"),
                        n = _.one(S, this.element, "DIV");
                    this.layout(v.bind(function() {
                        var r = e.offsetHeight + (i ? i.offsetHeight : 0),
                            o = t || this.sandbox.height();
                ...
                handleResize: function(t, i) {
                    ...
                    }, this)) : (this.recalculateStreamHeight(i), twttr.events.trigger("resize", {
                        target: this.sandbox.element()
                    })), e.doLayoutAsync())
                }
            }), t(T)
        ...
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params", "dom/classname", "dom/get", "performance/perf-timers", "util/env", "util/promise", "util/util", "util/throttle", "util/twitter", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", "tfw/util/media", function(e, i, n, r, o, s, a, u, l, c, d, h, f, m, w, p) {
            function g(t, e, i, n) {
                var r = s.one("subject", t, "BLOCKQUOTE"),
                    o = s.one("reply", t, "BLOCKQUOTE"),
                    a = r && r.getAttribute("data-tweet-id"),
                    u = o && o.getAttribute("data-tweet-id"),
                    l = {}, d = {};
                a && (l[a] = {
                    item_type: 0
                }, w.enqueue({
                    ...
                    item_ids: [a],
                    item_details: l
                }), !0, n), w.scribeTweetAudienceImpression(n), u && (d[u] = {
                    item_type: 0
                }, w.enqueue({
                    page: "tweet",
            ...
            function v(t, e, i) {
                ...
                t && (n[t] = {
                    ...
                    widget_origin: f.url(),
                    widget_frame: f.frameUrl(),
                    message: e,
                    item_ids: [t],
                    item_details: n
                }, !0, i), w.scribeTweetAudienceImpression(i))
            }
            ...
            var T = "tweetembed",
                x = {}, A = [],
                E = [];
            _.prototype = new i, c.aug(_.prototype, {
                ...
                updateTimeStamps: function() {
                    var t = s.one("long-permalink", this.element, "A"),
                        i = t.getAttribute("data-datetime"),
                        n = i && this.datetime.localTimeStamp(i),
                        r = t.getElementsByTagName("TIME")[0];
                ...
                var t, i, n = x,
                    r = [];
                if (x = {}, n.keys) r = n.keys();
                else
                    for (t in n) n.hasOwnProperty(t) && r.push(t);
                r.length && (w.initPostLogging(), i = n[r[0]][0].lang, m.tweets({
                    ids: r.sort(),
                    lang: i,
                    complete: function(t) {
        ...
        var n = {};
        t(function(t, r, o) {
            var s, a = document.createElement("span"),
                u = {}, l = "",
                c = 0,
                d = 0,
                h = [];
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function(e, i, n, r, o, s, a) {
            ...
            u.prototype = new i, e.aug(u.prototype, {
                iframeSource: "/widgets/follow_button.21f7daa948263c3043bab783473c3475.{{lang}}.html",
                widgetUrlParams: function() {
                    return e.compact({
                ...
                width: function() {
                    ...
                    var t, i, n = {
                            ...
                            xlcnt: 22,
                            xlbtn: 38
                        }, r = this.showScreenName ? "Follow %{screen_name}" : "Follow",
                        o = this._(r, {
                            screen_name: "@" + this.screenName
                        }),
                        s = this._(~e.indexOf(["ja", "ko"], this.lang) ? "10k unit" : "M"),
                        u = this._("%{followers_count} followers", {
                ...
                render: function(t, i) {
                    ...
                    var n = this.makeIframeSource(),
                        r = this.create(n, this.dimensions(), {
                            title: this._("Twitter Follow Button")
                        }).then(e.bind(function(t) {
        ...
        using("tfw/widget/base", "tfw/util/globals", "util/util", "util/querystring", "util/uri", "util/twitter", "util/typevalidator", "dom/textsize", function(e, i, n, r, o, s, a, u) {
            function l(t) {
                e.apply(this, [t]);
                var r = this.params(),
                    a = r.count || this.dataAttr("count"),
                    u = r.size || this.dataAttr("size"),
                    l = o.getScreenNameFromPage(),
                    m = "" + (r.shareWithRetweet || this.dataAttr("share-with-retweet") || i.val("share-with-retweet"));
            ...
            var c = document.title,
                d = location.href,
                h = ["vertical", "horizontal", "none"],
                f = [, "never", "publisher-first", "publisher-only", "author-first", "author-only"];
            l.prototype = new e, n.aug(l.prototype, {
                iframeSource: "/widgets/tweet_button.d58098f8a7f0ff5a206e7f15442a6b30.{{lang}}.html",
                widgetUrlParams: function() {
                    return n.compact({
                        text: this.text,
                        url: this.url,
        ...
        using("util/util", "util/promise", "util/twitter", "tfw/widget/base", "tfw/widget/tweetbutton", "tfw/widget/follow", "tfw/widget/embed", "tfw/widget/timeline", function(e, i, n, r, o, s, a, u) {
            function l(t, n, o, s) {
                return t = t || [], o = o || {},
                function() {
                    var a, u, l, c, d = Array.prototype.slice.apply(arguments, [0, t.length]),
            ...
            var d = l(["url"], o, {
                ...
                m = l(["screenName"], s),
                w = l(["tweetId"], a, {}, a.fetchAndRender),
                p = l(["widgetId"], u),
                g = l(["previewParams"], c),
                v = {
                    createShareButton: d,
            ...
            if (n.start("widgets-js-load"), !e.ie6()) {
                ...
                twttr.events = {
                    ...
                    using("tfw/widget/base", "tfw/widget/follow", "tfw/widget/tweetbutton", "tfw/widget/embed", "tfw/widget/timeline", "tfw/widget/intent", "tfw/factories", "tfw/util/article", "util/events", "util/util", function(t, e, n, s, a, u, l, c, d, h) {
                        ...
                        var w, p = {
                                widgets: {
                                    "a.twitter-share-button": n,
                                    "a.twitter-mention-button": n,
                                    "a.twitter-hashtag-button": n,
